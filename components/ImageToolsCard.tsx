...
const ImageToolsCard = () => {
    return (
        <div className="bg-white/90 backdrop-blur-md rounded-[24px] p-[30px] transition-all
         duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] relative overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.1)]">
            <div className="w-full h-[180px] rounded-[16px] overflow-hidden mb-[25px] relative">
                <img className="w-full h-full object-cover transition-transform duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]" src="/1.png" alt="" />
            </div>
            ...
            <p className="text-[17px] text-gray-500 leading-[1.6] mb-[25px]">
                Transform your creative ideas into stunning visuals using our advanced image
                Resizer technology. Create unique artwork in seconds.
            </p>
