        ...
        <div className="flex items-center justify-center min-h-screen bg-white overflow-auto py-10 px-4">
            ...
            <div className="grid w-[86%] md:w-[70%] lg:w-[55%] gap-5">
                <div className="pt-10 px-6 ">
                    <h1 className=" font-extrabold text-[30px] lg:text-[42px] leading-[52px] text-[#33333b] text-center">Doc To Text Converter</h1>
                    <h2 className="max-w-[800px]  mx-auto leading-[32px] text-[16px] lg:text-[22px] font-normal text-[#47474f] text-center">Convert your doc files to txt  free
                    </h2>
                </div>
