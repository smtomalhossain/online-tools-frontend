        ...
        <div className="flex items-center justify-center min-h-screen bg-white overflow-auto py-10 px-4">
            ...
            <div className="grid w-[86%] md:w-[70%] lg:w-[55%] gap-5">
                <div className="pt-10 px-6 ">
                    <h1 className=" font-extrabold text-[25px] md:text-[37px] lg:text-[42px] leading-[52px] text-[#33333b] text-center">PDF To Text Converter</h1>
                    <h2 className="max-w-[800px]  mx-auto leading-[32px] text-[16px] lg:text-[22px] font-normal text-[#47474f] text-center">Convert your PDF files to Text free
                    </h2>
                </div>
                ...
                <div className="p-5">
                    <button className="mx-auto bg-blue-500 text-white flex items-center gap-3 min-h-[56px] text-2xl leading-7 rounded-xl font-medium px-6 py-4 hover:bg-blue-600 cursor-pointer">
                        <span className="font-bold height: 24px;">Convert to Text</span>
